...
<script>
	...
	function decreaseQty(id) {
		...
		if (qty == 1) {
			...
			let itemDecrease = document.getElementById('price-detail-qty' + id).innerHTML;
			let itemDecQty = Number(itemDecrease);
			alert(itemDecrease);
			// .innerHTML = Number(document.getElementById('price-detail-qty'+id).innerHTML) - 1;
			// alert(document.getElementById('price-detail-qty'+id).innerHTML);
