...
{
    echo "<div class=\"border rounded\" id=\"cart$id\">
                    <div class=\"row bg-white cart-row-modify\">
                          ...
                          <div class=\"col-md-6\">
                                ...
                                <button type=\"submit\" onclick=\"removeProductFrCart($id)\" class=\"btn btn-danger\" name=\"remove\">Remove</button>
                          </div>
                          <div class=\"col-md-3\">
                                <div>
                                      <button type=\"button\" onclick=\"decreaseQty($id)\" class=\"btn bg-light border rounded-circle\"><i class=\"fa fa-minus\"></i></button>
                                      <input type=\"text\" id=\"pro$id\" value=\"$qty\" class=\"form-control qty-modify\">
