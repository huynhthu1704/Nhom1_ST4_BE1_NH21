				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<ul class="product-btns">
							<li class="h<?php  $getProduct['id']?>"><a style="cursor:pointer" onclick="addToWishlist(<?php echo $getProduct['id']; ?>)"><i class="fa fa-heart-o <?php echo $icon_color_change?>"></i> add to wishlist</a></li>
						</ul>
