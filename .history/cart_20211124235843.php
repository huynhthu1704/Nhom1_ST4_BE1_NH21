      ...
      <div class="row px-5">
            <div class="col-md-7">
                  <div class="shopping-cart">
                        <h3 style="padding: 30px 0 0 0 !important">My Cart</h3>
                        <hr>
                        <?php
                        if ($count != 0) { ?>
                                    ...
                                    <div class="border rounded">
                                          ...
                                          <div class="row bg-white cart-row-modify">
                                                ...
                                                <div class="col-md-6">
                                                      ...
                                                      <h4 class="pt-2"><?php echo number_format($getProduct[0]['price']) ?></h4>
                                                      <button type="submit" class="btn btn-danger" name="remove">Remove</button>
                                                </div>
                                                <div class="col-md-3">
                                                      <div>
                                                            <button type="button" class="btn bg-light border rounded-circle"><i class="fa fa-minus"></i></button>
                                                            <input type="text" value="1" class="form-control w-10 d-inline">
