									...
									<div class="cart-list">
										...
										<div class="product-widget">
											<div class="product-img">
												<img src="./img/<?php $getProduct[0]['pro_image']; ?>" alt="">
											</div>
											<div class="product-body">
												<h3 class="product-name"><a href="detail.php?id=<?php echo $value['pro_id']?>">product name goes here</a></h3>
												<h4 class="product-price"><span class="qty">1x</span><?php echo $getProduct[0]['price']?></h4>
											</div>
