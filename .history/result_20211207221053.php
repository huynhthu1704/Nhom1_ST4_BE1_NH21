...
if (isset($_GET['submit'])) {
    ...
    if ($keyword != "") {
        ...
        $search =$type_id == 0? array() : $product->searchNameByTypeID($type_id);
    }
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb-tree">
                    <li><a href="#">Home</a></li>
                    <li class="active"><?php if (isset($_GET['keyword'])){echo $_GET['keyword']; }?> (227,490 Results)</li>
                </ul>
            </div>
        </div>
        <!-- /row -->
                ...
                <div class="aside">
                    ...
                    <div class="checkbox-filter">
                        ...
                        if (isset($_GET['submit'])) {
                            if ($keyword == "") {
                                if ($type_id != 0) {
                                    $name = $product->getManuNameByType($type_id);
                                    $count = $product->getCountProductByType($type_id);
                                } 
                            } else {
                                if ($type_id != 0) {
                                    ...
                                    $name = $product->getManuName($keyword, $type_id);
                                    $count = $product->getCountProduct($keyword, $type_id);
                                }
                            }
