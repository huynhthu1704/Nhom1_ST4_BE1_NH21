		...
		<div class="row">
			...
			<div class="col-md-7">
				...
				<div class="billing-details">
					...
					if (count($cusInfor) == 1) {
						$firstname = $cusInfor['first_name'];
						$lastname = $cusInfor['last_name'];
						$email = $cusInfor['email'];
						$address = $cusInfor['order_address'];
						$city = $cusInfor['city'];
						$zipcode = $cusInfor['xip_code'];
						$telephone = $cusInfor['phone_number'];
					}
					?>
