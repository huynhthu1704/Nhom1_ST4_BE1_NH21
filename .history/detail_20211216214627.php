											...
											<ul id="rating-progress-list" class="rating">
												<li>
													...
													<div class="rating-progress">
														<div style="width: <?php echo round(($star5 / $count) * 100); ?>%;"></div>
													</div>
												...
												<li>
													...
													<div class="rating-progress">
														<div style="width: <?php echo round(($star4 / $count) * 100); ?>%;"></div>
													</div>
												...
												<li>
													...
													<div class="rating-progress">
														<div style="width: <?php echo round(($star3 / $count) * 100); ?>%;"></div>
													</div>
												...
												<li>
													...
													<div class="rating-progress">
														<div style="width: <?php echo round(($star2 / $count) * 100); ?>%;"></div>
													</div>
												...
												<li>
													...
													<div class="rating-progress">
														<div style="width: <?php echo round(($star1 / $count) * 100); ?>%;"></div>
													</div>
