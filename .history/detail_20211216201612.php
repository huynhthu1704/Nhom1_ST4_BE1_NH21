												...
												<ul class="rating">
													<li>
														...
														<div class="rating-progress">
															<div style="width: <?php echo round(($star5/$totalStar) * 100)?>%;"></div>
														</div>
													...
													<li>
														...
														<div class="rating-progress">
															<div style="width: <?php echo round(($star4/$totalStar) * 100)?>%;"></div>
														</div>
													...
													<li>
														...
														<div class="rating-progress">
														<div style="width: <?php echo round(($star3/$totalStar) * 100)?>%;"></div>
														</div>
													...
													<li>
														...
														<div class="rating-progress">
														<div style="width: <?php echo round(($star2/$totalStar) * 100)?>%;"></div>
														</div>
													...
													<li>
														...
														<div class="rating-progress">
														<div style="width: <?php echo round(($star1/$totalStar) * 100)?>%;"></div>
														</div>
