	...
	<div id="rating">
		...
		<ul id="rating-progress-list" class="rating">
			...
			<li>
				...
				<div class="rating-progress">
					<div style="width: <?php if ($count != 0) {echo round(($star4 / $count) * 100); } else {echo 0;}?>%;"></div>
				</div>
			...
			<li>
				...
				<div class="rating-progress">
					<div style="width: <?php if ($count != 0) {echo round(($star3 / $count) * 100); } else {echo 0;}?>%"></div>
				</div>
			...
			<li>
				...
				<div class="rating-progress">
					<div style="width: <?php if ($count != 0) {echo round(($star2 / $count) * 100); } else {echo 0;}?>%"></div>
				</div>
			...
			<li>
				...
				<div class="rating-progress">
					<div style="width: <?php if ($count != 0) {echo round(($star1 / $count) * 100); } else {echo 0;}?>%"></div>
				</div>
