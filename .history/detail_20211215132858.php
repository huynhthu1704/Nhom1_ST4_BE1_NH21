					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div class="add-to-cart">
								<div class="qty-label">
									...
									<div class="input-number">
										<input onfocusout="checkQty(<?php echo $getProduct['id'];?>)" id="pro<?php echo $getProduct['id'] ?>"  type="number">
							...
							<ul class="product-btns">
								<li><a onclick="addToWishlist(<?php echo $getProduct['id']; ?>)"><i class="fa fa-heart-o"></i> add to wishlist</a></li>
							</ul>
