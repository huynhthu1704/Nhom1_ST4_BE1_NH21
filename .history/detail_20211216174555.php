			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<?php
						$reviewPro = $review->getAllReviewByID($getProduct['id']);
						?>
							<div>
								...
								<a class="review-link" href="#tab2"><?php echo count($reviewPro)?>(s) | Add your review</a>
							</div>
						<?php  ?>
						<div>
							<?php
							...
							<h3 class="product-price"><?php echo number_format($getProduct['price']) ?> <del class="product-old-price"><?php if ($discount_price != 0) {echo $discount_price;} ?></del></h3>
										...
										<div id="review-form">
											<div class="review-form">
												...
												<div class="input-rating">
													...
													<div class="stars">
														<input onchange="rating()" class="rating-star" id="star5" name="rating" data-rating="5" type="radio"><label for="star5"></label>
														<input class="rating-star" id="star4" name="rating" data-rating="4" type="radio"><label for="star4"></label>
														<input class="rating-star" id="star3" name="rating" data-rating="3" type="radio"><label for="star3"></label>
														<input class="rating-star" id="star2" name="rating" data-rating="2" type="radio"><label for="star2"></label>
														<input class="rating-star" id="star1" name="rating" data-rating="1" type="radio"><label for="star1"></label>
