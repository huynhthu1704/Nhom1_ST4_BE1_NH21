        ...
        $new . "
            ...
            <div class=\"product-body\">
                ...
                <div class=\"product-btns\">
                    <button onclick=\"addToWishlist($id)\" class=\"add-to-wishlist\"><i class=\"fa fa-heart-o h$id $icon_color_change\"></i><span class=\"tooltipp\">add to wishlist</span></button>
                </div>
            </div>
            <div class=\"add-to-cart\">
                <button onclick=\"addCart($id, 1)\" name=\"add-to-cart\" class=\"add-to-cart-btn\"><i class=\"fa fa-shopping-cart\"></i> add to cart</button>
            </div>
...
function getProduct($value, $getNewProducts, $discount, $session_wishlist)
{
    ...
    component($value['pro_image'], $dis_Percent, $isNew, $value['type_name'], $value['id'], $value['name'], $discount_price,  $value['price'], $check);
}
...
//   </form>";
// }
function component1($img,$discount_percent, $type_name, $id, $name, $discount_price, $old_price)
{
    $percent = $discount_percent == 0 ? "" :  "<span class=\"sale\">- " . $discount_percent . "%</span>";
    ...
    echo "
        ...
        <div class=\"product-img\">
        <img src=\".\img\\$img\" alt=\"\" height=\"40\" class=\"img\">
        </div>
        <div class=\"product-body\">
                <p class=\"product-category\">$type_name</p>
...
function getOrder($value, $getNewProducts, $discount)
{
    ...
    component1($value['pro_image'],$dis_Percent, $value['type_name'], $value['id'], $value['name'], $discount_price,  $value['price']);
}
