...
if (isset($_GET['id'])) {
	...
	$allReview = $review->getAllReviewByProductID($id);
	$count = count($allReview);
	// get 4 review per page
	$reviewPro = $review->get3Reviews($id, $page, $perPage);
	$avarageRating = 0;
	$totalStar = 0;
	$star1 = 0;
	$star2 = 0;
				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<div>
							...
							<a class="review-link" href="#tab2"><span class="total-review"><?php echo $count ?></span> (s) | Add your review</a>
						</div>
						<?php  ?>
						<div>
							<?php
				...
				<div class="col-md-12">
					<div id="product-tab">
						...
						<ul class="tab-nav">
							...
							<li><a data-toggle="tab" href="#tab2">Reviews (<span class="total-review"><?php echo $count ?></span>)</a></li>
						</ul>
						<!-- /product tab nav -->
						<!-- product tab content -->
								...
								<div class="row">
											...
											<ul id="rating-progress-list" class="rating">
												<li>
													...
													<div class="rating-progress">
														<div style="width: <?php if ($count != 0) {
																				echo round(($star5 / $count) * 100);
																			} else {
																				echo 0;
																			} ?>%"></div>
													</div>
									...
									<div class="col-md-6">
										<div id="reviews">
											...
											<ul id="reviews-pagination"  class="reviews-pagination">
												<?php
												$totalLinks = ceil($count / $perPage);
												$link = "";
												for ($j = 1; $j <= $totalLinks; $j++) {
													if ($j == $page) {
												?>
														<li class="active"><a onclick="paginate(<?php echo $id.','.$j.','.$perPage?>)" href=""><?php echo $j?></a></li>
													<?php
													} else {
													?>
														<li><a onclick="paginate(<?php echo $id.','.$j.','.$perPage?>)" href=""><?php echo $j?></a></li>
												<?php
													}
												}
												echo $link;
										...
										<div id="review-form">
											<div class="review-form">
												...
												<div class="input-rating">
													...
													<div class="stars">
														<input class="rating-star" id="star5" name="rating" value="5" type="radio"><label for="star5"></label>
												...
												<div id="noti"></div>
												<button name="add-review" id="add-review" class="primary-btn" onclick="addReview(<?php echo $id.','.$perPage ?>)">Submit</button>
											</div>
										</div>
									</div>
									<!-- /Review Form -->
