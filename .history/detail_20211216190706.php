				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<div>
							...
							<a class="review-link" href="#tab2"><span id="total-review"><?php echo count($reviewPro) ?></span>(s) | Add your review</a>
						</div>
						<?php  ?>
						<div>
							<?php
				...
				<div class="col-md-12">
					<div id="product-tab">
						...
						<ul class="tab-nav">
							...
							<li><a data-toggle="tab" href="#tab2">Reviews (<span id="total-review"><?php echo count($reviewPro)?></span>)</a></li>
						</ul>
						<!-- /product tab nav -->
						<!-- product tab content -->
									...
									<div class="col-md-3">
										<div id="rating">
											<div class="rating-avg">
												...
												<div class="rating-stars review-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
