									...
									<div class="cart-list">
										...
										<div class="product-widget">
											...
											<div class="product-body">
												<h3 class="product-name"><a href="detail.php?id=<?php echo $value['id'] ?>"><?php echo $value['id']; ?></a></h3>
												<h4 class="product-price"><span class="qty"><?php echo $value['qty'] ?> x </span><?php echo number_format($value['price']); ?></h4>
											</div>
