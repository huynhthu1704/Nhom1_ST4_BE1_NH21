									...
									<div class="cart-list">
										...
										<div class="product-widget">
											...
											<div class="product-body">
												<h3 class="product-name"><a href="detail.php?id="><?php echo $getProduct[0]['name']; ?></a></h3>
												<h4 class="product-price"><span class="qty"><?php echo $value['pro_id']['qty'] ?> x </span><?php echo number_format($getProduct[0]['price']); ?></h4>
											</div>
