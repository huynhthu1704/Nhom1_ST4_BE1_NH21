                  ...
                  <div class="shopping-cart">
                        ...
                        if ($count != 0) { ?>
                              <form action="cart.php" method="get">
                                    <div id="cart-pro" class="border rounded">
                                          <?php
                                          ...
                                          ?>
                                                <div id="p<?php echo $value['id'] ?>" class="row bg-white cart-row-modify">
                                                      <div class="col-md-3">
                                                            <img src="./img/<?php echo $value['image']; ?>" alt="" height="100" class="img">
                                                      </div>
                                                      <div class="col-md-6">
                                                            <h4 class="pt-2"><?php echo $value['name'] ?></h4>
                                                            <h5 class="pt-2"><?php echo number_format($value['price']) ?></h5>
                                                            <button type="submit" class="btn btn-danger" name="remove" value="<?php $value['id']?>">Remove</button>
                                                      </div>
                                                      <div class="col-md-3">
                                                            <div>
