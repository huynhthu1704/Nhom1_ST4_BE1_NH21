        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="list_order.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php $countKH=$customer->getCountCustomer();
                echo $countKH[0]['dem'] ?></h3>
                <p>Customer</p>
              </div>
              <div class="icon">
