            ...
            foreach ($getAllManufactures as $value) { ?>
              <tr>
                ...
                <td class="project-actions text-left">
                  <a class="btn btn-info btn-sm modify-icon" href="manufacture_edit.php?manu_id=<?php echo $value['manu_id'] ?>">
                    <i class="fas fa-pencil-alt ">
                    </i>
                    Edit
                  </a>
                  <a class="btn btn-danger btn-sm modify-icon" href="manufacture_delete.php?manu_id=<?php echo $value['manu_id'] ?>">
